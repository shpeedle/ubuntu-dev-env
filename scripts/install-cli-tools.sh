...
command -v rg &> /dev/null && log_info "ripgrep: $(rg --version | head -n1)"
...
command -v eza &> /dev/null && log_info "eza: $(eza --version | head -n1)"
command -v jq &> /dev/null && log_info "jq: $(jq --version)"
command -v yq &> /dev/null && log_info "yq: $(yq --version)"
command -v htop &> /dev/null && log_info "htop: $(htop --version | head -n1)"
command -v tldr &> /dev/null && log_info "tldr: installed"
command -v ncdu &> /dev/null && log_info "ncdu: $(ncdu --version | head -n1)"
